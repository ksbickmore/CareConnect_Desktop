...
/**
 * Large `[ − ]  value  [ + ]` stepper (SRS Feature B / C3): replaces sliders
 * and numeric typing, which are barred for CTS users. Exposed as a
 * `role="spinbutton"` with aria-valuenow/min/max so screen readers announce
 * the reading; each change is also announced politely.
 */
